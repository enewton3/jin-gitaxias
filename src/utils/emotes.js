...
const manaEmojiMap = {
  ...
  "{11}": {textName: "11", emoji: "<:mana11:1064005291617820762>", },
  "{12}": {textName: "12", emoji: "<:mana12:1064006181280030740>", },
  "{13}": {textName: "13", emoji: "<:mana13:1064006182274080769>", },
  "{14}": {textName: "14", emoji: "<:mana14:1064005295350747136>", },
  "{15}": {textName: "15", emoji: "<:mana15:1064006184820023377>", },
  "{16}": {textName: "16", emoji: "<:mana16:1064005298785890405>", },
  "{17}": {textName: "17", emoji: "<:mana17:1064006186128650240>", },
  "{18}": {textName: "18", emoji: "<:mana18:1064006188129337395>", },
  "{19}": {textName: "19", emoji: "<:mana19:1064006189559599124>", },
  "{20}": {textName: "20", emoji: "<:mana20:1064006190889173003>", },
  "{100}": {textName: "100", emoji: ":mana101:1064006301618819143><:mana102:1064005302032273529", },
  "{1000000}": {textName: "1000000", emoji: "<:mana10000001:1064006303275569263> <:mana10000002:1064006305284620308><:mana10000003:1064006306274488412> <:mana10000004:1064005305853300826>", },
  ...
  "{W/P}": {textName: "W or P", emoji: "<:manawp:1067211164389494825>", },
  "{U/P}": {textName: "U or P", emoji: "<:manaup:1067211163269607605>", },
  "{B/P}": {textName: "B or P", emoji: "<:manabp:1067211156999110737>", },
  "{R/P}": {textName: "R or P", emoji: "<:manarp:1067211161566724137>", },
  "{G/P}": {textName: "G or P", emoji: "<:managp:1067211159171764256>", },
  "{2/W}": {textName: "2 or W", emoji: "<:mana2w:1064005282772045824>", },
  "{2/U}": {textName: "2 or U", emoji: "<:mana2u:1064005281652158524>", },
  "{2/B}": {textName: "2 or B", emoji: "<:mana2b:1064005277927608365>", },
  "{2/R}": {textName: "2 or R", emoji: "<:mana2r:1064005280142213221>", },
  "{2/G}": {textName: "2 or G", emoji: "<:mana2g:1064005278883921950>", },
  "{W/U}": {textName: "W or U", emoji: "<:manawu:1067212641388462130>", },
  "{W/B}": {textName: "W or B", emoji: "<:manawb:1067212640075661352>", },
  "{U/R}": {textName: "U or R", emoji: "<:manaur:1067212636984442943>", },
  "{U/B}": {textName: "U or B", emoji: "<:manaub:1067212638813171792>", },
  "{B/G}": {textName: "B or G", emoji: "<:manabg:1067212626913931267>", },
  "{B/R}": {textName: "B or R", emoji: "<:manabr:1067212628205772902>", },
  "{R/G}": {textName: "R or G", emoji: "<:manarg:1067212634484654122>", },
  "{R/W}": {textName: "R or W", emoji: "<:manarw:1067212635768094741>", },
  "{G/U}": {textName: "G or U", emoji: "<:managu:1067212630911098950>", },
  "{G/W}": {textName: "G or W", emoji: "<:managw:1067212632286838917>", },
  "{∞}": {textName: "Infinity", emoji: "<:manainfinity:1067226381773197422>", },
  "{½}": {textName: "Half", emoji: "<:manahalf:1067569846579122266> ",},
  "{HW}": {textName: "Half White", emoji: "<:manahw:1067569946898464799>",},
  "{HR}": {textName: "Half Red", emoji: " <:manahr:1067569942955827230>",},
  "{W/U/P}": {textName: "W/U/P", emoji:'<:manawup:1067650958835863584>',}, 
  "{W/B/P}": {textName: "W/B/P", emoji:'<:manawbp:1067650966788255774>',},
  "{U/B/P}": {textName: "U/B/P", emoji:'<:manaubp:1067650963428614225>',}, 
  "{U/R/P}": {textName: "U/R/P", emoji:'<:manaurp:1067650965202796634>',}, 
  "{B/G/P}": {textName: "B/G/P", emoji:'<:manabgp:1067650890342879382>',}, 
  "{B/R/P}": {textName: "B/R/P", emoji:'<:manabrp:1067650893090144256>',}, 
  "{R/G/P}": {textName: "R/G/P", emoji:'<:manargp:1067650899796840518>',}, 
  "{R/W/P}": {textName: "R/W/P", emoji:'<:manarwp:1067650952993189928>',}, 
  "{G/U/P}": {textName: "G/U/P", emoji:'<:managup:1067650894168076359>',}, 
  "{G/W/P}": {textName: "G/W/P", emoji:'<:managwp:1067650898374971554>',},
};
